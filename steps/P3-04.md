...
4. アプリの URL にアクセスして、タイトルに V1 が入っていることを確認します。

    <img src="../images/P2-05-check-index-page.png" width="700">

5.  API アプリの リポジトリの `springapps-petclinic-microservices/spring-petclinic-api-gateway/src/main/resources/static/scripts/fragments/welcome.html` のメッセージを更新した上で、`main` ブランチにコミットします。 <br>
...
6. ワークフロー処理が自動的に起動されていることを確認します。
...
4. アプリの `URL` にアクセスして、タイトルに V2 が入っていることを確認します。
