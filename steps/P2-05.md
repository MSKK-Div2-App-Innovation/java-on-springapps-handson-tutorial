...
4.  API アプリの リポジトリの `springapps-petclinic-microservices/spring-petclinic-api-gateway/src/main/resources/static/index.html` にメッセージを追加し、`main` ブランチにコミットします。 
