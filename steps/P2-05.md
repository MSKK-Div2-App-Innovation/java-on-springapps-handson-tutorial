...
ソースコードを修正してリポジトリにコミットしたときに、ワークフローが自動的に起動され、速やかに修正内容を Spring Apps にデプロイするよう、 GitHub Actions のワークフローへ Trigger 設定を追加します。
...
5. [**講習 1) タスク 4 - Azure CLI を使用した Azure Spring Apps のデプロイ**](P1-04.md#%E5%8B%95%E4%BD%9C%E7%A2%BA%E8%AA%8D) にてメモしておいたアプリの URL にアクセスして、更新したタイトルが表示されていることを確認します。
