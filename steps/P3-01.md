...
3. ターミナル画面を開きます。Green 環境を作成するため、以下のコマンドを実行します。
...
## 確認
4. [Azure Spring Apps](https://portal.azure.com/#view/HubsExtension/BrowseResource/resourceType/Microsoft.AppPlatform%2FSpring) を開きます、`アプリ` メニューをクリックします。
